...
public class Configuration {
    ...
    /**
     * 配置信息 对应着mybatis-config.xml文件的环境变量配置 <environments></environments>
     */
    public static Properties PROPS = new Properties();

    /**
     * MappedStatement信息 mapper.xml 中的方法信息 key：namespace+sqlId
     */
    ...
    /**
     * 根据 namespace+sqlId 查询对应的mappedStatement信息
     * 
     * @param key
     *            namespace+sqlId
